            ...
            <div className="max-w-6xl mx-auto px-4 lg:px-0">
                ...
                <div className="lg:hidden">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-8">
                        {/* Quick Links */}
                        <div>
                            <h4 className="text-gray-900 font-semibold font-[var(--font-poppins)] mb-4 text-base">
                                Quick Links
                            </h4>
                            <ul className="space-y-3">
                                {quickLinks.map((link) => (
                                    <li key={link.to}>
                                        <NavLink
                                            to={link.to}
                                            className="text-gray-600 hover:text-[var(--color-primary)] text-sm font-[var(--font-primary)] transition-colors duration-200"
                                        >
                                            {link.label}
                                        </NavLink>
                                    </li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start gap-2 text-sm text-gray-600 font-[var(--font-primary)]">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex items-center gap-4 mb-3">
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-700 hover:text-[var(--color-primary)] transition-colors duration-200">
                            ...
                            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-700 hover:text-[var(--color-primary)] transition-colors duration-200">
                        ...
                        <p className="text-sm text-gray-500 font-[var(--font-primary)] leading-relaxed">
                ...
                <div className="border-t border-gray-200 pt-5">
                    <p className="text-center text-sm text-gray-500 font-[var(--font-primary)]">
