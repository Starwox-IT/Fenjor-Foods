        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="text-gray-800 font-primary text-sm sm:text-base leading-relaxed mb-2 max-w-lg mx-auto lg:mx-0">
              While you're using our kitchen, don't forget to visit the Flenjor
              Foods Store for all your specialty ingredients, African spices,
              and cooking supplies. We're here to support your entire culinary
              journey.
            </p>
            ...
            <div className="flex justify-center lg:justify-start">
              <NavLink
                ...
                target="_blank"
                className="bg-[#DC5E32] cursor-pointer hover:bg-[#c24f28] text-white font-semibold font-primary text-sm py-3.5 px-8 rounded-lg transition-colors w-full sm:w-auto"
              >
                Visit the Store
              </NavLink>
            </div>
